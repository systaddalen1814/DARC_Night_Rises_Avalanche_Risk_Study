...
setwd("~/Desktop/Spring 2025/Capstone/DARC_Night_Rises_Avalanche_Risk_Study/1_DataClean")

file_list <- list.files(path = "14_product", pattern = "\\.csv$", full.names = TRUE)
...
for (var in tempdata_vars) {
  ...
  tryCatch({
    ...
    plot_filename <- file.path("15_datavis", paste0(var, "_missing_plot.jpeg"))
